...
public class MainActivity extends AppCompatActivity {
    ...
    String api_key = "8f5f6df0585d0d2b95c786ab35858e78";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        gridView = (GridView) findViewById(R.id.moviesview);
    ...
    public class GetMovies extends AsyncTask<String,Void,Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                JSONObject main = new JSONObject(jsonMovie);
                ...
                if (reader != null) {
                    try {
                        ...
                        Log.e(LOG_TAG, "Error in Streaming");
                    }
                }
            }
